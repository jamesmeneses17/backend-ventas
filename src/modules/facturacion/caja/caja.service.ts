...
export class CajaService {
    ...
    async remove(id: number) {
        ...
        if (registro.ventaId || registro.compraId || registro.pagoCreditoId) {
            throw new BadRequestException('Error: No se puede eliminar por aquí. Debe anular la Compra, Venta o Abono original.');
        }
